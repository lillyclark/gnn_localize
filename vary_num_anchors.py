...
if __name__ == "__main__":
    ...
    filename = "vary_num_anchors.txt"
    figname1 = "vary_num_anchors_compare.jpg"
    figname2 = "vary_num_anchors_runtime.jpg"

    num_nodes = 500
    num_anchors_list = [25,50,75,100]
    ...
    def writeA():
        ...
        file_handle.write("num_anchors_list: " + str(num_anchors_list) + '\n')
    ...
    ax1.plot(num_anchors_list, novel_list, marker='o',color='blue',label="SMILE")
    ax1.plot(num_anchors_list, gcn_list, marker='o',color='orange',label="GCN")
    ax1.set_xlabel(f'Number of Anchors ({num_nodes} Nodes)')
    ax1.set_ylabel('RMSE')
    ax1.legend()
    fig1.tight_layout()
    ...
    ax2.plot(num_anchors_list, novel_list, marker='o',color='blue')
    ax2.set_xlabel(f'Number of Anchors ({num_nodes} Nodes)')
    ax2.set_ylabel('RMSE')
    ax2.tick_params(axis='y', labelcolor='blue')
    ax3 = ax2.twinx()
    ax3.plot(num_anchors_list, novel_runtime_list, marker='o', color='orange')
