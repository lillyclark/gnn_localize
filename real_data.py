from process_dataset import load_a_moment, load_cellphone_data
...
if modelname == "novel":
    for batch in data_loader:
        ...
        for k1 in k1s:
            ...
            X, Y, ff = separate_dataset_multiple_inits(noisy_distance_matrix, k0=4, k1=int(k1), n_init=1, lam=lam, mu=mu, eps=0.001)
            # print(X)
            ffs.append(ff)
        ...
        print("BEST RMSE:")
        print(min(RMSEs))
        print("at k1:", k1s[np.argmin(np.array(RMSEs))])
