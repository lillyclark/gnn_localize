...
if __name__ == "__main__":
    ...
    num_nodes = 500
    num_anchors = 50
    true_locs = torch.rand((num_nodes-num_anchors,2))*5
    gcn_pred = true_locs + torch.rand((num_nodes-num_anchors,2))*0.1
    novel_pred = true_locs + torch.rand((num_nodes-num_anchors,2))*0.05
    plot_rmse("tmp.jpg", true_locs, {"GCN":gcn_pred, "SMILE":novel_pred})
