...
if __name__ == "__main__":
    ...
    print("EXPERIMENT: vary percentage nLOS")
    filename = "vary_nLOS.txt"
    figname = "vary_nLOS.jpg"
    num_nodes = 500
    num_anchors = 50
    ...
    ax1.plot(percent_nLOS_list, novel_list, marker='o',color='blue',label="SMILE")
    ax1.plot(percent_nLOS_list, gcn_list, marker='o',color='orange',label="GCN")
    ax1.set_xlabel('Probability (%) nLOS')
    ax1.set_ylabel('RMSE')
    ax1.legend()
    plt.tight_layout()
    plt.savefig(figname)
